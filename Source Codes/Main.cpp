...
bool isVisible = true;
bool isGod = true;
bool setkillsModifier = true
bool isGod2 = true
bool isSetBigHead = false;
bool isAddCoins = true
bool isAddGems = true;
bool isAddCoupons = true;
bool isRecoil = true
bool isScatterReduction = false;
bool isCriticalHit = true;
bool isRegenHealth = true;
bool isRegenArmor = true;
bool isAmmo1 = true
bool isAmmo2 = true
bool isLevel = true;
bool isAutoShoot = false;
bool isVip = true
bool isRapidfire = true
bool isDamage = false;
bool isBulletexplode = false;
bool isShotgun = true
bool isReflectdamage = true
